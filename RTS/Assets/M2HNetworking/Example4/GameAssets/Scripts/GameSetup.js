...
static var usedStartLocs = new ArrayList();
...
function OnNetworkLoadedLevel()
{
	...
	usedStartLocs.Add(Mathf.RoundToInt(Random.Range(0, spawnpoints.length)));
	for (var i = 0; i < spawnpoints.length; i ++)
	{
		if (usedStartLocs.Count == i)
		{
			usedStartLocs.Add(Random.Range(0, spawnpoints.length));
			i = -1;
		}
		else
			break;
	}
	var spawnpoint : Transform = spawnpoints[usedStartLocs.Count].transform;
